...
// TODO: cuando armemos productsStore y ordersStore, reemplazar estos
// placeholders por los datos reales de esos stores.
const misProductos: Array<{
  id: string;
  nombre: string;
  categoria: string;
  precio: number;
    ...
    >
      ...
      <View style={styles.card}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValue}>🛠️ {user.role}</Text>
        </View>
        <View style={styles.infoRow}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoValueBold}>{user.memberSince}</Text>
        </View>
        <View style={styles.infoRow}>
          <Text style={styles.infoLabel}>Pedidos realizados</Text>
          {/* TODO: reemplazar por ordersStore cuando exista */}
          <Text style={styles.infoValueBold}>0</Text>
        </View>
      </View>
      ...
      {misProductos.length === 0 ? (
        <View style={styles.emptyBox}>
          <Text style={styles.emptyBoxText}>
            Todavía no publicaste ningún medicamento.
          </Text>
          <Pressable
            ...
            <View key={producto.id} style={styles.productoCard}>
              ...
              <View style={styles.productoInfo}>
                ...
                <Text style={styles.productoPrecio}>
                  ${producto.precio.toLocaleString("es-AR")} · Stock:{" "}
                  {producto.stock}
                </Text>
              </View>
            </View>
